Shader "Custom/ProvinceGen"
{
    ...
    SubShader
    {
        ...
        float countryBorderToggle; // 1 is provinces, 0 is only countries.
        ...
        float4 Frag(V2F i) : SV_Target {
            ...
            */
            ...
            // Cant use bitwise operator on floats.
            float index = p.r * 255 + p.g * 255 * 256;
            float state = p.b * 255 + p.a * 255 * 256;
            ...
            float iU = up.r * 255 + up.g * 255 * 256;
            float iD = down.r * 255 + down.g * 255 * 256;
            float iL = left.r * 255 + left.g * 255 * 256;
            float iR = right.r * 255 + right.g * 255 * 256;
        
            float sU = up.b * 255 + up.a * 255 * 256;
            float sD = down.b * 255 + down.a * 255 * 256;
            float sL = left.b * 255 + left.a * 255 * 256;
            float sR = right.b * 255 + right.a * 255 * 256;
